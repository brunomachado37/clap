...
import data.libero.tensor_utils as TensorUtils
...
class LiberoBatchTransform:
    ...
    def __call__(self, batch):
        ...
        lang = batch["task_description"].lower()
...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def __len__(self):
        ...
        """
        if self.hdf5_cache_mode == "low_dim" and self.episodic:
            return self.n_demos
    ...
    def __getitem__(self, index):
        ...
        elif self.hdf5_cache_mode == "low_dim" and self.episodic:
            return self.get_episode(index)
        return self.get_item(index)

    def get_episode(self, index):
        actions = self.hdf5_cache[f'demo_{index}']['actions']
